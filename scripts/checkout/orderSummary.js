...
import dayjs from 'https://unpkg.com/dayjs@1.11.10/esm/index.js'; // use external day.js library
...
export function renderOrderSummary(){
    ...
    cart.forEach((cartItem)=>{
        ...
        // to show delivery date above container
    ...
    // delivery option need to be real dates.
    ...
    // when user pick up delivery option
